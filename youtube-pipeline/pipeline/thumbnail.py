"""Composites a click-worthy thumbnail: a frame grabbed from the #1 (best)
clip in the video, darkened for contrast, with bold title text overlaid.
"""
...
def build_thumbnail(cfg: dict, background_path: str, title_text: str, out_path: str) -> str:
    ...
    img = ImageEnhance.Contrast(ImageEnhance.Brightness(img).enhance(0.6)).enhance(1.15)
